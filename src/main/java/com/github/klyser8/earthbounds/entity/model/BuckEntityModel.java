...
public class BuckEntityModel extends AnimatedGeoModel<BuckEntity> {
    ...
    @Override
    public Identifier getModelResource(BuckEntity object) {
        return new Identifier(Earthbounds.MOD_ID, "geo/misc/generic_buck.geo.json");
    }

    @Override
    public Identifier getTextureResource(BuckEntity buck) {
    ...
    @Override
    public Identifier getAnimationResource(BuckEntity animatable) {
