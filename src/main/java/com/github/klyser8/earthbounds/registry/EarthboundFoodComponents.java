...
public class EarthboundFoodComponents {
    ...
    public static final FoodComponent DIORITE_PEBBLE = new FoodComponent.Builder().hunger(2).saturationModifier(3).alwaysEdible().build();
    public static final FoodComponent GRANITE_PEBBLE = new FoodComponent.Builder().hunger(1).saturationModifier(4).alwaysEdible().build();
    public static final FoodComponent REDSTONE_PEBBLE = new FoodComponent.Builder().hunger(5).saturationModifier(5).alwaysEdible().build();
    public static final FoodComponent PRIMORDIAL_REDSTONE = new FoodComponent.Builder().hunger(10).saturationModifier(7).alwaysEdible().build();
