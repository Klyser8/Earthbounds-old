...
public class EarthboundParticles {
    ...
    public static final DefaultParticleType RUBRO_MADDER = FabricParticleTypes.simple();
    ...
    public static final DefaultParticleType SMALL_HEART = FabricParticleTypes.simple();
    ...
    public static void register() {
        ...
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(Earthbounds.MOD_ID, "rubro_madder"), RUBRO_MADDER);
        ...
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(Earthbounds.MOD_ID, "small_heart"), SMALL_HEART);
    }
    ...
    public static void registerFactories() {
        ...
        ParticleFactoryRegistry.getInstance().register(RUBRO_MADDER, RubroMadderParticle.Factory::new);
        ...
        ParticleFactoryRegistry.getInstance().register(SMALL_HEART, SmallHeartParticle.Factory::new);
    }
