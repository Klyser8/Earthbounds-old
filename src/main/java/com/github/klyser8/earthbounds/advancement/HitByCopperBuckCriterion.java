...
public class HitByCopperBuckCriterion extends AbstractCriterion<HitByCopperBuckCriterion.Conditions> {

    static final Identifier ID = new Identifier(Earthbounds.MOD_ID, "hit_by_copper_buck");
