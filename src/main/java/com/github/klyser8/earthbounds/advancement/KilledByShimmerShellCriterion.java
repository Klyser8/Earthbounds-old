...
public class KilledByShimmerShellCriterion extends AbstractCriterion<KilledByShimmerShellCriterion.Conditions> {

    static final Identifier ID = new Identifier(Earthbounds.MOD_ID, "killed_by_shimmer_shell");
