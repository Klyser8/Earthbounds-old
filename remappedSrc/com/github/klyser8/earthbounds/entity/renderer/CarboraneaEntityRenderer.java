...
import com.github.klyser8.earthbounds.entity.model.CarboraneaModel;
...
public class CarboraneaEntityRenderer extends GeoEntityRenderer<CarboraneaEntity> {
     ...
     * Baby carboraneas should be smaller in size and have no outer shell.
